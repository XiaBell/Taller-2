...
public class SandboxArreglos
{
    ...
    public String[] getCopiaCadenas( )
        ...
        {
        	String [] nuevoarreglo = new String[]{};
    ...
    {
    	 int finalindex = (getCantidadEnteros());
    	 this.arregloEnteros[finalindex] = entero;
    }
    ...
    {
   	 int finalindex = (getCantidadCadenas());
   	 this.arregloCadenas[finalindex] = cadena;
